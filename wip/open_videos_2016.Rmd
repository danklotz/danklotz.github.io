...
Videos/Lectures I want to watch or have watched in 2016.
...
# Other Random Stuff:
- [Franz-Josef Radermacher: Der Mensch und die digitale Maschine - Was kommt auf uns zu?](https://youtu.be/xjNT5Y-nEH0)
...
# The Logic of Science Reading Course
...
- {x} The exhaust emissions scandal 
- {x} My Robot Will Crush You With Its Soft Delicate Hands!
- {x} The Great Train Cyber Robbery 
- {x} Internet Landscapes 
...
- {x} Freakshow 
- {x} Any.cast
- {x} Methodisch inkorrekt! 
- {x} Check your privileges! 
- {  } Say hi to your new boss: How algorithms might soon control our lives 
- {x} Computational Meta-Psychology 
- {x} Prediction and Control 
- {x} On Computing Numbers, with an Application to Problems of our Society 
- {x} Maritime Robotics 
- {x} Hacker Geopardy
- {x} Predicting Crime in a Big data World 
- {x} Realitätsabgleich 
- {x} How the Great Firewall discovers hidden circumvention servers 
...
- {x} What can we learn from Mr Dawkins error and misuse of probability?
- {x} Sornete vs. Taleb 
